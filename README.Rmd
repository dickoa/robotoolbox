...
you will need the [`remotes`](https://github.com/r-lib/remotes) package to install it from Gitlab.
...
You can use `remotes::install_github` or the [`pak`](https://github.com/r-lib/pak) package to install it from Github.
