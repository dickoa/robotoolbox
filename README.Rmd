...
`robotoolbox` uses the `labelled` package to manipulate `labels` for `select_one` question types. For `select_multiple` questions, dummy columns are used. These dummy variables lack value label but they have variable labels associated to the variable of label of the original variable.
