...
You will need to set your API token and specify your `KoboToolbox` server URL. The easiest way to set up `robotoolbox` is to store the token and the url in your `.Renviron`.
