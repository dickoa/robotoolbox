...
```
    ...
    #>  Rows: 5
    #>  Columns: 21
    #>  $ start                <dttm> 2022-05-09 18:31:40, 2022-05-09 18:31:53, 2022-05-09 18:32:04, 2022-05-09 18:32:33, …
    #>  $ end                  <dttm> 2022-05-09 18:35:12, 2022-05-09 18:34:59, 2022-05-09 18:34:47, 2022-05-09 18:34:37, …
    #>  $ today                <date> 2022-05-09, 2022-05-09, 2022-05-09, 2022-05-09, 2022-05-09
    ...
    #>  $ instanceID           <chr> "uuid:147d4f30-7459-42f7-818f-b44f47b2cca7", "uuid:6f67ede0-c594-4a28-bf7b-c40c0ef2f…
    #>  $ deprecatedID         <chr> "uuid:6840ad57-d9f7-4557-b1f2-11af21e5b0cd", "uuid:3cbdc3ec-bd0a-4ace-81a1-98a0486322…
    #>  $ uuid                 <chr> "5c0d08e4deda4a7fbc9634f5e8aba62f", "5c0d08e4deda4a7fbc9634f5e8aba62f", "5c0d08e4deda…
    #>  $ `__version__`        <chr> "vjPe5qiVxTmyviYSrQE3x4", "vjPe5qiVxTmyviYSrQE3x4", "vjPe5qiVxTmyviYSrQE3x4", "vjPe5q…
    #>  $ `_xform_id_string`   <chr> "atbUaNGu5PWR2u4tNDsYaH", "atbUaNGu5PWR2u4tNDsYaH", "atbUaNGu5PWR2u4tNDsYaH", "atbUaN…
    #>  $ `_uuid`              <chr> "147d4f30-7459-42f7-818f-b44f47b2cca7", "6f67ede0-c594-4a28-bf7b-c40c0ef2fcad", "8954…
    #>  $ `_status`            <chr> "submitted_via_web", "submitted_via_web", "submitted_via_web", "submitted_via_web", "…
    #>  $ `_submission_time`   <dttm> 2022-05-09 18:32:03, 2022-05-09 18:32:10, 2022-05-09 18:32:44, 2022-05-09 18:33:01, 2…
...
#>  Rows: 5
#>  Columns: 21
#>  $ start                                    <dttm> 2022-05-09 18:31:40, 2022-05-09 18:31:53, 2022-05-09 18:32:04, 2…
#>  $ end                                      <dttm> 2022-05-09 18:35:12, 2022-05-09 18:34:59, 2022-05-09 18:34:47, 2…
#>  $ today                                    <date> 2022-05-09, 2022-05-09, 2022-05-09, 2022-05-09, 2022-05-09
...
#>  $ `_id`                                    <int> 20939261, 20939265, 20939278, 20939288, 20939301
#>  $ instanceID                               <chr> "uuid:147d4f30-7459-42f7-818f-b44f47b2cca7", "uuid:6f67ede0-c594…
#>  $ deprecatedID                             <chr> "uuid:6840ad57-d9f7-4557-b1f2-11af21e5b0cd", "uuid:3cbdc3ec-bd0a-…
#>  $ uuid                                     <chr> "5c0d08e4deda4a7fbc9634f5e8aba62f", "5c0d08e4deda4a7fbc9634f5e8ab…
#>  $ `__version__`                            <chr> "vjPe5qiVxTmyviYSrQE3x4", "vjPe5qiVxTmyviYSrQE3x4", "vjPe5qiVxTmy…
#>  $ `_xform_id_string`                       <chr> "atbUaNGu5PWR2u4tNDsYaH", "atbUaNGu5PWR2u4tNDsYaH", "atbUaNGu5PWR…
#>  $ `_uuid`                                  <chr> "147d4f30-7459-42f7-818f-b44f47b2cca7", "6f67ede0-c594-4a28-bf7b-…
#>  $ `_status`                                <chr> "submitted_via_web", "submitted_via_web", "submitted_via_web", "s…
#>  $ `_submission_time`                       <dttm> 2022-05-09 18:32:03, 2022-05-09 18:32:10, 2022-05-09 18:32:44, 20…
#>  $ `_validation_status`                     <chr> NA, NA, NA, NA, NA
#>  $ `_submitted_by`                          <lgl> NA, NA, NA, NA, NA
```
